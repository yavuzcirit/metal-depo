    ...
    <div>
      {value ? (
        ...
        <button
          ...
          disabled={uploading}
          className="flex w-full flex-col items-center justify-center gap-3 rounded-lg border-2 border-dashed border-gray-200 bg-gray-50 py-10 transition-colors hover:border-navy hover:bg-blue-50/30 disabled:opacity-60"
        >
          {uploading ? (
